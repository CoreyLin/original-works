...
实际查看zookeeper的持久化数据
	...
	[yzapps@00VMTL-FabricPeer-172-19-102-62 mycompany]$ docker exec -it zookeeper0.mycompany.com bash
...
实际查看kafka的持久化数据
	...
	[yzapps@00VMTL-FabricPeer-172-19-102-62 mycompany]$ docker exec -it kafka0.mycompany.com bash
...
实际查看peer的持久化数据
	...
	[yzapps@00VMTL-FabricPeer-172-19-102-62 mycompany]$ docker exec -it peer0.org1.mycompany.com bash
...
实际查看orderer的持久化数据
	...
	[yzapps@00VMTL-FabricPeer-172-19-102-62 mycompany]$ docker exec -it orderer0.mycompany.com bash
...
### 2.通过docker cp命令把容器中的数据拷贝到本地
	...
	docker cp zookeeper0.mycompany.com:/data /home/yzapps/hyperledger/fabric-samples/mycompany/backup/zookeeper0.mycompany.com/data
	docker cp zookeeper0.mycompany.com:/datalog /home/yzapps/hyperledger/fabric-samples/mycompany/backup/zookeeper0.mycompany.com/datalog
	
	docker cp kafka0.mycompany.com:/tmp/kafka-logs /home/yzapps/hyperledger/fabric-samples/mycompany/backup/kafka0.mycompany.com/tmp/kafka-logs
	
	docker cp orderer0.mycompany.com:/var/hyperledger/production /home/yzapps/hyperledger/fabric-samples/mycompany/backup/orderer0.mycompany.com/var/hyperledger/production
	
	docker cp peer0.org1.mycompany.com:/var/hyperledger/production /home/yzapps/hyperledger/fabric-samples/mycompany/backup/peer0.org1.mycompany.com/var/hyperledger/production
...
zk:
    ...
    volumes:
        - /home/yzapps/hyperledger/fabric-samples/mycompany/backup/zookeeper0.mycompany.com/data:/data
        - /home/yzapps/hyperledger/fabric-samples/mycompany/backup/zookeeper0.mycompany.com/datalog:/datalog
		
kafka:

    volumes:
        - /home/yzapps/hyperledger/fabric-samples/mycompany/backup/kafka0.mycompany.com/tmp/kafka-logs:/tmp/kafka-logs
		
orderer:

    volumes:
		- /home/yzapps/hyperledger/fabric-samples/mycompany/backup/orderer0.mycompany.com/var/hyperledger/production:/var/hyperledger/production
		
peer:

    volumes:
        - /home/yzapps/hyperledger/fabric-samples/mycompany/backup/peer0.org1.mycompany.com/var/hyperledger/production:/var/hyperledger/production
...
在peer0.org1 cli上调用之后，链码容器dev-peer0.org1.mycompany.com-mycc-1.0就会自动被生成。

在peer0.org2 cli上调用之后，链码容器dev-peer0.org2.mycompany.com-mycc-1.0就会自动被生成。
